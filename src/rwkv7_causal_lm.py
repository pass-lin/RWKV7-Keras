from src.backbone import RWKV7Backbone, rwkv7_kernel_initializer
from keras_hub.src.models.causal_lm import CausalLM
from src.rwkv7_causal_lm_preprocessor import RWKV7CausalLMPreprocessor
import keras
...
class RWKV7CausalLM(CausalLM):
    ...
    def _build_cache(self, token_ids):
        ...
        last_token_cache = ops.zeros(
            [batch_size, num_layers, 2, 1, hidden_size], dtype=self.compute_dtype
        )
    ...
    def generate_step(
        ...
        padding_mask = ops.concatenate(
            [ops.cast(ops.not_equal(token_ids, 0), padding_mask.dtype), padding_mask],
            axis=1,
        )
